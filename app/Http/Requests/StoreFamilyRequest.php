...
class StoreFamilyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'parent.firstname_zh' => 'sometimes|nullable|string|max:50',
            'parent.lastname_zh' => 'sometimes|nullable|string|max:50',
            ...
            'student.firstname_zh' => 'sometimes|nullable|string|max:50',
            'student.lastname_zh' => 'sometimes|nullable|string|max:50',
